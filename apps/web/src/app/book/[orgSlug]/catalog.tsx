...
export function Catalog({
  orgSlug: pOrgSlug,
  embedded = false,
}: { orgSlug?: string; embedded?: boolean } = {}) {
  ...
  return (
    <Wrapper className={embedded ? "fade-in mx-auto max-w-6xl p-4 md:p-6" : "mx-auto max-w-6xl p-4 md:p-8"}>
      <section className="fade-in">
        ...
        <header className="mb-6">
          ...
          <p className="mt-1 text-body-lg text-text-muted">
            {embedded ? "Browse rooms and book in a few taps." : "No account needed — reserve in minutes."}
          </p>
          {!embedded && (
