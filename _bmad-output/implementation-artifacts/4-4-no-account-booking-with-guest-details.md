...
guestBookings.create: guest record (name/phone required; email/dob/nationality/idType/idNumber optional) + REQUIRED consent (consentAt) -> pending booking. Validation: consent, phone, past check-in, bad range -> rejected, nothing written. Transactional availability re-check prevents double-booking (FR4, FR5, FR8, NFR13).
