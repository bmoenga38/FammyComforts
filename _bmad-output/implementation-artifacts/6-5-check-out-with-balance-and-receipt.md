...
deskBookings.checkOut: ledger balance verified; outstanding balance BLOCKS checkout unless an explicit audited exception (reason) is granted; final payments recorded via payments.recordManual; receipt issued via invoices.generate (FR22, NFR14).
