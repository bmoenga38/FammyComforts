...
catalog.rooms (public, org-by-slug): cards with status, KES price (lowest active plan), capacity, branch location. Web: /book/[orgSlug] catalog with guest-facing polish (FR1, UX-DR7).
